...
var SummaryPage_1 = require('../views/SummaryPage');
var ctx = null;
...
var ProjectSurvey = function (_SurveyView_1$SurveyV) {
    ...
    _createClass(ProjectSurvey, [{
        ...
        key: "summaryMoveNext",
        value: function summaryMoveNext(email) {
...
ProjectSurvey.contextTypes = (_ProjectSurvey$contex = {}, _defineProperty(_ProjectSurvey$contex, "isLoggedIn", React.PropTypes.func.isRequired), _defineProperty(_ProjectSurvey$contex, "exists", React.PropTypes.func.isRequired), _defineProperty(_ProjectSurvey$contex, "login", React.PropTypes.func.isRequired), _defineProperty(_ProjectSurvey$contex, "register", React.PropTypes.func.isRequired), _defineProperty(_ProjectSurvey$contex, "hasPaymentMethod", React.PropTypes.func.isRequired), _defineProperty(_ProjectSurvey$contex, "addPaymentMethod", React.PropTypes.func.isRequired), _defineProperty(_ProjectSurvey$contex, "paymentToken", React.PropTypes.func.isRequired), _ProjectSurvey$contex);
ProjectSurvey.childContextTypes = SelectionControl_1.SelectionControl.contextTypes;
__decorate([core_decorators_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', []), __metadata('design:returntype', Boolean)], ProjectSurvey.prototype, "moveNext", null);
__decorate([core_decorators_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', []), __metadata('design:returntype', Boolean)], ProjectSurvey.prototype, "moveBack", null);
__decorate([core_decorators_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', [String]), __metadata('design:returntype', void 0)], ProjectSurvey.prototype, "summaryMoveNext", null);
