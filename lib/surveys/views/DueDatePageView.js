...
class DueDatePageView extends SelectionControl_1.SelectionControl {
    ...
    get token() {
        ...
        if (token == null)
            token = common_1.DueDateQuestion.token;
        return token;
    }
    get defaultTimeUtc() {
    ...
    render() {
        ...
        if (isFinite(value))
            value = "yes";
        return (React.createElement(SurveyPage_1.SurveyPage, __assign({}, this.props), 
            React.createElement(RadioGroup_1.RadioGroup, __assign({}, this.props, {options: common_1.DueDateQuestion.options, token: null, value: value, valueRef: this.onSelect})), 
            this.renderDate()));
    }
    renderDate() {
        ...
        return React.createElement("div", {className: "order-wizzard__date-group"}, 
            React.createElement("span", null, this.renderDateView(value)), 
            React.createElement("span", null, this.renderTimeView(value)), 
            React.createElement("span", null, this.renderZoneView(value)));
    }
    renderDateView(date) {
        return React.createElement(DateField, {value: date, forceValidDate: true, updateOnDateClick: true, dateFormat: "YYYY-MM-DD", onChange: this.onSetDate}, 
            React.createElement(Calendar, {style: { padding: 10 }})
        );
    }
    renderTimeView(date) {
...
], DueDatePageView.prototype, "onSelect", null);
__decorate([
    core_decorators_1.autobind, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], DueDatePageView.prototype, "onSetDate", null);
__decorate([
    core_decorators_1.autobind, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [Object, Object]), 
    __metadata('design:returntype', void 0)
], DueDatePageView.prototype, "onSetTime", null);
__decorate([
    core_decorators_1.autobind, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', [String]), 
    __metadata('design:returntype', void 0)
], DueDatePageView.prototype, "onSetZone", null);
