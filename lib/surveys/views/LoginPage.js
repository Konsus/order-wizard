...
var LoginPage = function (_React$Component) {
    ...
    _createClass(LoginPage, [{
        ...
        value: function renderLoginPage() {
            ...
            return React.createElement("div", { className: "order-wizzard order-wizzard--login" }, React.createElement("div", { className: "order-wizzard__header" }, React.createElement("div", { className: "order-wizzard__title" }, "Thank you!"), React.createElement("div", { className: "order-wizzard__sub-title" }, "Please sign in and your quote will be with you shortly")), React.createElement("div", { className: "order-wizzard__login" }, React.createElement("div", { className: "order-wizzard__login-form" }, React.createElement("div", { className: "form-group" }, React.createElement("input", { type: "email", className: "form-control", ref: function ref(x) {
                    return _this6.email = x;
                }, defaultValue: this.props.email, placeholder: "Email" })), React.createElement("div", { className: "form-group" }, React.createElement("input", { type: "password", className: "form-control", ref: function ref(x) {
                    return _this6.password = x;
                }, placeholder: "Password" })), React.createElement("button", { type: "submit", className: "btn btn-primary btn-block", onClick: this.login }, " Log in"))));
        }
    }]);
