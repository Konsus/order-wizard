...
var CreditCardPage = function (_React$Component) {
    ...
    _createClass(CreditCardPage, [{
        ...
        value: function renderView() {
            var token = this.state.token;
            return React.createElement("div", null, React.createElement("div", { className: "order-wizzard__header" }, React.createElement("div", { className: "order-wizzard__sub-title" }, "Add your credit card details so we are ready to go if you approve the quote.")), React.createElement("form", null, React.createElement(DropIn, { braintree: braintree, clientToken: token })), React.createElement("button", { type: "submit", className: "btn btn-primary btn-block", onClick: this.submitCreditCard }, " Submit"));
        }
    }, {
        key: "renderLoading",
