...
var CreditCardPage = function (_React$Component) {
    ...
    _createClass(CreditCardPage, [{
        ...
        value: function submitCreditCard() {
        ...
        value: function componentDidMount() {
            ...
            this.props.hasPaymentMethod().then(function (hasPaymentMethod) {
                ...
                return _this2.props.paymentToken().then(function (token) {
        ...
        value: function renderView() {
            var token = this.state.token;
            return React.createElement("div", null, React.createElement("div", { className: "order-wizzard__header" }, React.createElement("div", { className: "order-wizzard__sub-title" }, "Add your credit card details so we are ready to go if you approve the quote.")), React.createElement("form", { style: { margin: '20px' } }, React.createElement(DropIn, { braintree: braintree, clientToken: token })), React.createElement("button", { type: "submit", style: { width: '80%', margin: 'auto' }, className: "btn btn-primary btn-block", onClick: this.submitCreditCard }, " Submit"));
        }
    }, {
        key: "renderLoading",
...
__decorate([core_decorators_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', []), __metadata('design:returntype', void 0)], CreditCardPage.prototype, "submitCreditCard", null);
