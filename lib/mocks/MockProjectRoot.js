...
var MockProjectRoot = function (_ProjectSurveyRoot_1$) {
    ...
    _createClass(MockProjectRoot, [{
        ...
        value: function addPaymentMethod(nonce) {
            console.log(nonce);
            return Promise.resolve();
        }
    }, {
...
__decorate([core_decorators_1.autobind, __metadata('design:type', Function), __metadata('design:paramtypes', [String]), __metadata('design:returntype', Promise)], MockProjectRoot.prototype, "addPaymentMethod", null);
