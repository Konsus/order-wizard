...
var MockProjectRoot = function (_ProjectSurveyRoot_1$) {
    ...
    _createClass(MockProjectRoot, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", null, React.createElement("div", { style: { margin: 2 } }, React.createElement("div", { className: "checkbox" }, React.createElement("label", null, " ", React.createElement("input", { type: "checkbox", checked: this.state.loggedIn, onChange: function onChange(e) {
                    return _this3.handleCheckBox("loggedIn", e);
                } }), "Logged In")), React.createElement("div", { className: "checkbox" }, React.createElement("label", null, " ", React.createElement("input", { type: "checkbox", checked: this.state.newUser, onChange: function onChange(e) {
                    return _this3.handleCheckBox("newUser", e);
                } }), "New User")), React.createElement("div", { className: "checkbox" }, React.createElement("label", null, " ", React.createElement("input", { type: "checkbox", checked: this.state.creditCard, onChange: function onChange(e) {
