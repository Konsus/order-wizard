...
class Comment extends SelectionControl_1.SelectionControl {
    ...
    renderActiveView() {
        ...
        return React.createElement("div", { className: "order-wizzard__text-comment", key: this.props.id || token }, React.createElement("label", null, label), React.createElement("textarea", { className: "form-control", name: token, value: value, placeholder: this.props.placeholder, onChange: this.onChange }));
    }
}
