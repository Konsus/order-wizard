...
class DatePicker extends SelectionControl_1.SelectionControl {
    ...
    renderActiveView() {
        ...
        return React.createElement("div", {className: "order-wizzard__text-date", key: this.props.id || token}, 
            React.createElement("label", null, label || value), 
            React.createElement("br", null), 
            React.createElement(ReactDatePicker, {className: "form-control", name: token, selected: value, todayButton: "Today!", onChange: this.onChange, placeholderText: this.props.placeholder}));
    }
}
__decorate([
