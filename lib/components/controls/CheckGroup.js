...
class CheckBox extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: "order-wizzard__list-item order-wizzard__checkbox", key: this.props.id || value, onClick: this.onClick }, React.createElement("input", { type: "checkbox", ref: x => this.input = x, value: value, label: label, checked: checked, onChange: this.onChange }), React.createElement("label", null, React.createElement("span", null, label || value)));
    }
}
