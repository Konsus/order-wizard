...
class SurveyWindow extends React.Component {
    ...
    render() {
        return (React.createElement("div", null, 
            ...
            React.createElement(Modal, {isOpen: this.state.visible, onRequestClose: this.close, style: customStyles}, 
                React.createElement("div", {className: "modal-cross-close", onClick: this.close}), 
                this.props.children)));
    }
    renderDebug() {
...
], SurveyWindow.prototype, "open", null);
__decorate([
    core_decorators_1.autobind, 
    __metadata('design:type', Function), 
    __metadata('design:paramtypes', []), 
    __metadata('design:returntype', void 0)
], SurveyWindow.prototype, "close", null);
