...
class SurveyView extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: "order-wizzard" }, React.createElement("div", { className: "order-wizzard__progress" }, React.createElement(react_bootstrap_1.ProgressBar, { now: this.progress() * 100 })), React.createElement("div", { className: "order-wizzard__step" }, this.renderQuestionPage()), React.createElement("div", { className: "order-wizzard__controls clearfix" }, React.createElement("div", { className: "order-wizzard__back pull-left" }, React.createElement("a", { onClick: () => this.moveBack(), href: "#", className: "b-button b-button--transparent" }, React.createElement("span", { className: "b-button__icon-arrow" }), " Back")), React.createElement("div", { className: "order-wizzard__next pull-right" }, this.renderMoveNext())));
    }
    renderMoveNext() {
        if (!this.canMoveNext()) return null;
        if (this.state.isPageDone) return React.createElement("a", { onClick: () => this.moveNext(), href: "#", className: "b-button b-button--blue" }, "Next");
