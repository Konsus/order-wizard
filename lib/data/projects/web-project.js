...
exports.WebSiteLinkQuestion = {
    ...
    token: nameof(null.website_link),
    active: (form) => form.website == "existing",
    resize: "none",
    rows: 1,
};
exports.WebSitePage = {
...
exports.TechRequirementsQuestion = {
    token: nameof(null.tech_requirement),
...
exports.TechPreferencesQuestion = {
    token: nameof(null.tech_preferences),
...
exports.TechPreferencesPage = {
    ...
    active: (form) => {
        ...
        if (services instanceof Array) {
            if (services.indexOf("structure") >= 0)
                return true;
            if (services.indexOf("implementation") >= 0)
                return true;
            return false;
        }
        return true;
