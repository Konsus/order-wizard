...
exports.WebSiteQuestion = {
    ...
    token: "website",
    options: [{ value: "new", label: "Making a new website" }, { value: "existing", label: "Improve an existing website" }]
};
...
exports.TechRequirementsQuestion = {
    ...
    options: [{ value: "no", label: "No, please use the most suitable tech" }, { value: "yes", label: "Yes" }]
};
