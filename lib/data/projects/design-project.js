...
exports.ServiceQuestion = {
    ...
    options: [{ value: "logo-design", label: "Logo design" }, { value: "advertisements", label: "Advertisements" }, { value: "marketing", label: "Brochures and marketing material" }, { value: "branding", label: "Corporate branding" }, { value: "other", label: "Other illustrations or infographics" }],
    other: { label: "Other" }
};
exports.ServicePage = {
...
class DesignProjectSurvey {
    constructor() {
        ...
        this.survey = {
            ...
            pages: [this.service, this.design, this.style, this.files, this.deadline, this.comments]
        };
    }
}
