...
exports.ServiceQuestion = {
    ...
    options: [{ value: "logo-design", label: "Logo design" }, { value: "advertisements", label: "Advertisements" }, { value: "marketing", label: "Brochures and marketing material" }, { value: "branding", label: "Corporate branding" }, { value: "digitalization", label: "Digitalization of sketch" }, { value: "other", label: "Other illustrations or infographics" }],
    other: { label: "Other" }
};
exports.ServicePage = {
