...
exports.TemplateQuestion = {
    ...
    options: [{ value: "yes", label: "Yes." }, { value: "no", label: "No, but please include that as part of delivery." }, {
...
exports.PurposeQuestion = {
    ...
    }, { value: "tables", label: "Normal size text, tables, charts and some details (for reading and reports)" }, { value: "both", label: "Combination of both" }]
};
exports.PurposePage = {
