...
exports.ServiceTypeQuestion = {
    ...
    options: [{ value: "from-pdf", label: "PDF to Excel, Word or similar" }, { value: "from-img", label: "Image to Excel, Word or similar" }, { value: "from-web", label: "Specific website to Excel, Word or similar" }, { value: "linked-in", label: "Contact details from LinkedIn" }, { value: "cleaning", label: "Data Cleaning" }],
    other: { label: "Other" }
};
