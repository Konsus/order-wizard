...
exports.ServiceTypeQuestion = {
    ...
    options: [{ value: "from-pdf", label: "PDF to Excel, Word or similar" }, { value: "from-img", label: "Image to Excel, Word or similar" }, { value: "from-web", label: "Website to Excel, Word or similar" }, { value: "linked-in", label: "Gathering contact information from LinkedIn" }, { value: "cleaning", label: "Data Cleaning" }, { value: "other", label: "Other" }]
};
